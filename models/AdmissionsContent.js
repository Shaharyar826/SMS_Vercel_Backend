...
AdmissionsContentSchema.statics.findOneOrCreate = async function(userId) {
  ...
  return this.create({
    ...
    mainContent: 'Welcome to the admissions page of Community Based High School. We are delighted that you are considering our school for your child\'s education.',
    admissionCriteria: {
      title: 'Admission Criteria',
      content: 'Admission to Community Based High School is based on the student\'s academic record, entrance test performance, and interview.'
    },
    applicationProcess: {
      title: 'Application Process',
      content: 'At Community Based High School, we welcome students from diverse backgrounds who demonstrate a commitment to learning and personal growth. Our admission process is designed to be straightforward while ensuring that we find the right fit for each student.',
      steps: [
        {
          stepNumber: 1,
          title: 'Application',
