...
AboutUsContentSchema.statics.findOneOrCreate = async function(userId) {
  ...
  return this.create({
    mainContent: 'Community Based High School was established in 1995 with a vision to provide quality education to the students of Tando Jam and surrounding areas.',
    vision: {
      title: 'Our Vision',
