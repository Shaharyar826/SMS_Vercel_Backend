...
AcademicsContentSchema.statics.findOneOrCreate = async function(userId) {
  ...
  return this.create({ 
    mainContent: 'At Community Based High School, we provide a comprehensive and balanced education that prepares students for academic success and personal growth.',
    curriculum: {
